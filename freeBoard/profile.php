                            ...
                            <form method='get' action=''>
                                ...
                                <tr>
                                    <td colspan='2'>
                                        ...
                                        <button type='submit' class='btn_submit' name='mode' value='remove' style='background-color: #E25345;'>
...
<?php
$input_name = $_POST['change_name'];
$input_email = $_POST['change_email'];
$input_pw = $_POST['change_pw'];
$input_pw_check = $_POST['change_pw_check'];
